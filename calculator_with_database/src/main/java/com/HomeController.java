...
public class HomeController {
    ...
    public String Calc(@ModelAttribute("firstvalue") int firstvalue,@ModelAttribute("operator") char operator, @ModelAttribute("secondvalue") int secondvalue, Model model) throws SQLException {
        ...
        Connection connection = dataSource.getConnection();
        PreparedStatement statement = connection.prepareStatement("insert into calculator (value1, value2, Result) values (?, ?, ?)");
